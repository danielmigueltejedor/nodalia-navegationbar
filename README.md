...
Si detecta Music Assistant, muestra ademas un boton rapido para abrir un navegador de medios embebido para esa entidad, con categorias, playlists y elementos reproducibles.
...
media_player:
  ...
  players:
    ...
    - entity: media_player.salon
      ...
      browse_path: /media-browser/browser
      icon: mdi:speaker
